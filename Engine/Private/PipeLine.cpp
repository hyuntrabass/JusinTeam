...
void CPipeLine::Tick()
{
	...
	m_vCameraPos = _vec4(m_TransformMatrix_Inversed[ToIndex(TransformType::View)].Position());
	m_vCameraLook = _vec4(m_TransformMatrix_Inversed[ToIndex(TransformType::View)].Look());
}
