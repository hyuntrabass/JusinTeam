...
namespace Engine
{
	...
	const D3D11_INPUT_ELEMENT_DESC VTXPOINT_INSTANCING::Elements[] =
	{
		...
		{ "PrevPrevPosition", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, 1, 80, D3D11_INPUT_PER_INSTANCE_DATA, 1}, /* Position */
		{ "Index", 0, DXGI_FORMAT_R32_FLOAT, 1, 96, D3D11_INPUT_PER_INSTANCE_DATA, 1}, /* Index */
		{ "Dissolve", 0, DXGI_FORMAT_R32_FLOAT, 1, 100, D3D11_INPUT_PER_INSTANCE_DATA, 1}, /* Dissolve */
	};
	...
	const D3D11_INPUT_ELEMENT_DESC VTXMESH_INSTANCING::Elements[] =
	{
		...
		{ "World", 2, DXGI_FORMAT_R32G32B32A32_FLOAT, 1, 32, D3D11_INPUT_PER_INSTANCE_DATA, 1}, /* World */
		{ "World", 3, DXGI_FORMAT_R32G32B32A32_FLOAT, 1, 48, D3D11_INPUT_PER_INSTANCE_DATA, 1}, /* World */
		{ "OldWorld", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, 1, 64, D3D11_INPUT_PER_INSTANCE_DATA, 1}, /* World */
		{ "OldWorld", 1, DXGI_FORMAT_R32G32B32A32_FLOAT, 1, 80, D3D11_INPUT_PER_INSTANCE_DATA, 1}, /* World */
		{ "OldWorld", 2, DXGI_FORMAT_R32G32B32A32_FLOAT, 1, 96, D3D11_INPUT_PER_INSTANCE_DATA, 1}, /* World */
		{ "OldWorld", 3, DXGI_FORMAT_R32G32B32A32_FLOAT, 1, 112, D3D11_INPUT_PER_INSTANCE_DATA, 1}, /* World */
		{ "ID", 0, DXGI_FORMAT_R32_UINT, 1, 128, D3D11_INPUT_PER_INSTANCE_DATA, 1}, /* InstanceID */
	};
