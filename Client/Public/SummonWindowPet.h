...
class CSummonWindowPet final : public COrthographicObject
{
public:
...
private:
	CSummonWindowPet(_dev pDevice, _context pContext);
	CSummonWindowPet(const CSummonWindowPet& rhs);
	virtual ~CSummonWindowPet() = default;
...
public:
	static CSummonWindowPet* Create(_dev pDevice, _context pContext);
