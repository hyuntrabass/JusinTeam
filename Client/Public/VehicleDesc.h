...
BEGIN(Client)
class CItem;
class CVehicleDesc final : public COrthographicObject
{
private:
...
private:
	CVehicleDesc(_dev pDevice, _context pContext);
	CVehicleDesc(const CVehicleDesc& rhs);
	virtual ~CVehicleDesc() = default;
...
public:
	static CVehicleDesc* Create(_dev pDevice, _context pContext);
