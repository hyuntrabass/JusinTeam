...
CClearEffect::CClearEffect(_dev pDevice, _context pContext)
	: COrthographicObject(pDevice, pContext)
{
}

CClearEffect::CClearEffect(const CClearEffect& rhs)
	: COrthographicObject(rhs)
{
}

HRESULT CClearEffect::Init_Prototype()
{
	return S_OK;
}

HRESULT CClearEffect::Init(void* pArg)
{
	...
	m_iTower = ((CLEAR_DESC*)pArg)->iTower;
	
	return S_OK;
}

void CClearEffect::Tick(_float fTimeDelta)
{
...
void CClearEffect::Late_Tick(_float fTimeDelta)
{
...
HRESULT CClearEffect::Render()
{
	...
	m_pGameInstance->Render_Text(L"Font_Malang", strText, _vec2((_float)g_iWinSizeX / 2.f, 360.f + 0.2f), 0.9f, _vec4(0.f, 0.f, 0.f, 1.f));
	m_pGameInstance->Render_Text(L"Font_Malang", strText, _vec2((_float)g_iWinSizeX / 2.f, 360.f), 0.9f, _vec4(1.f, 0.78f, 0.f, 1.f));

	m_pGameInstance->Render_Text(L"Font_Malang", TEXT("화면을 눌러 다음 층에 도전하세요."), _vec2((_float)g_iWinSizeX / 2.f - 0.2f, 580.f), 0.4f, _vec4(0.f, 0.f, 0.f, 1.f));
	m_pGameInstance->Render_Text(L"Font_Malang", TEXT("화면을 눌러 다음 층에 도전하세요."), _vec2((_float)g_iWinSizeX / 2.f + 0.2f, 580.f), 0.4f, _vec4(0.f, 0.f, 0.f, 1.f));
	m_pGameInstance->Render_Text(L"Font_Malang", TEXT("화면을 눌러 다음 층에 도전하세요."), _vec2((_float)g_iWinSizeX / 2.f, 580.f - 0.2f), 0.4f, _vec4(0.f, 0.f, 0.f, 1.f));
	m_pGameInstance->Render_Text(L"Font_Malang", TEXT("화면을 눌러 다음 층에 도전하세요."), _vec2((_float)g_iWinSizeX / 2.f, 580.f + 0.2f), 0.4f, _vec4(0.f, 0.f, 0.f, 1.f));
	m_pGameInstance->Render_Text(L"Font_Malang", TEXT("화면을 눌러 다음 층에 도전하세요."), _vec2((_float)g_iWinSizeX / 2.f, 580.f), 0.4f, _vec4(0.6f, 0.6f, 0.6f, 1.f));

	return S_OK;
}

HRESULT CClearEffect::Add_Parts()
{
...
HRESULT CClearEffect::Add_Components()
{
...
HRESULT CClearEffect::Bind_ShaderResources()
{
...
CClearEffect* CClearEffect::Create(_dev pDevice, _context pContext)
{
	CClearEffect* pInstance = new CClearEffect(pDevice, pContext);

	if (FAILED(pInstance->Init_Prototype()))
	{
		MSG_BOX("Failed to Create : CClearEffect");
...
CGameObject* CClearEffect::Clone(void* pArg)
{
	CClearEffect* pInstance = new CClearEffect(*this);

	if (FAILED(pInstance->Init(pArg)))
	{
		MSG_BOX("Failed to Clone : CClearEffect");
		Safe_Release(pInstance);
	}
