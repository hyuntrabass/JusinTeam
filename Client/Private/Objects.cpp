...
{
	if (CTrigger_Manager::Get_Instance()->Get_CurrentSpot() != TS_Village and CTrigger_Manager::Get_Instance()->Get_CurrentSpot() != TS_Tutorial and CTrigger_Manager::Get_Instance()->Get_CurrentSpot() != TS_Dungeon and CTrigger_Manager::Get_Instance()->Get_CurrentSpot() != TS_SurvivalMap)
	{
		return;
	}
