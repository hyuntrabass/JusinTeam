...
HRESULT CTextButton::Render()
{
	...
	if (m_strText != TEXT(""))
	{
		...
		m_pGameInstance->Render_Text(L"Font_Malang", m_strText, _vec2(m_vPosition.x + m_vTextPosition.x, m_vPosition.y + m_vTextPosition.y), m_fFontSize,  _vec4(0.f, 0.f, 0.f, 1.f));
